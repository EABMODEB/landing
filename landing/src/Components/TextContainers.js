    ...
    <section className={classes.boxContainer}>
      ...
      <div className={classes.boxBox}>
        ...
        <p className={classes.boxBoxParagraph}>
          Somos el Centro de Distribución Solar mas completo del país, buscamos
          junto con nuestros socios comerciales transformar a México a través de
          la energía solar. Trabajamos para alcanzar día con día nuestros
          objetivos: entregando diferenciadores que apoyen a mejorar el
          desempeño de los integradores en el mercado.
        </p>
      </div>
    </section>
  );
